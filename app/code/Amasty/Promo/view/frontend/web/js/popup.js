    ...
    $.widget('mage.ampromoPopup', {
        ...
        checkboxState: function (elem) {
            ...
            if (!($(elem).attr('checked'))) {
                $(elem.parentElement.parentElement).find('.ampromo-qty')[0].value = 0;
                $(elem.parentElement.parentElement).find('.ampromo-qty').keyup();
            }

            if ($(elem).attr('checked')) {
                $(elem.parentElement.parentElement).find('.ampromo-qty')[0].value = 1;
                $(elem.parentElement.parentElement).find('.ampromo-qty').keyup();
            }
