        ...
        $select = $adapter->select()
            ->from(
                ...
                [
                    ...
                    GiftRuleInterface::TOP_BANNER_IMAGE,
                    GiftRuleInterface::TOP_BANNER_ALT,
                    GiftRuleInterface::TOP_BANNER_ON_HOVER_TEXT,
                    GiftRuleInterface::TOP_BANNER_LINK,
                    GiftRuleInterface::TOP_BANNER_SHOW_GIFT_IMAGES,
                    GiftRuleInterface::TOP_BANNER_DESCRIPTION,
                    GiftRuleInterface::AFTER_PRODUCT_BANNER_IMAGE,
                    GiftRuleInterface::AFTER_PRODUCT_BANNER_ALT,
                    GiftRuleInterface::AFTER_PRODUCT_BANNER_ON_HOVER_TEXT,
                    GiftRuleInterface::AFTER_PRODUCT_BANNER_LINK,
                    GiftRuleInterface::AFTER_PRODUCT_BANNER_SHOW_GIFT_IMAGES,
                    GiftRuleInterface::AFTER_PRODUCT_BANNER_DESCRIPTION,
                    GiftRuleInterface::LABEL_IMAGE,
                    GiftRuleInterface::LABEL_IMAGE_ALT,
