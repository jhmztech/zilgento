...
namespace Amasty\Finder\Plugin\View\Page\Config;
...
class Renderer
{
    const CACHE_KEY = 'amasty_finder_should_load_css_file';
    ...
    public function beforeRenderAssets(
        ...
        if ($shouldLoad) {
            $this->config->addPageAsset('Amasty_Finder::css/source/mkcss/am-finder.css');
        }
