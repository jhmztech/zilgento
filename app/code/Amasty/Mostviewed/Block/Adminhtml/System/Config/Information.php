    ...
    public function getAdditionalModuleContent()
    {
        ...
        if (!$this->_scopeConfig->getValue(self::MESSAGE_CHECKER_PATH)
            ...
            $message = [
                'type' => 'message-error',
                'text' => __(
                    'The extension code has been completely renovated in v2.0.0. After update all the rules created previously become disabled. Please recheck the rules configuration before enabling them.'
                )
            ];
